...
function App() {
  ...
  const URL = `https://api.openweathermap.org/data/2.5/weather?q=${busq}&lang=es&units=metric&appid=${
    ...
    <>
      <div className="bg-radial-[at_50%_75%] from-sky-200 via-blue-400 to-indigo-900 to-90% w-full h-screen flex justify-center items-center font-quicksand">
        <motion.div
          ...
          className="bg-slate-200 w-[70%] text-center rounded-2xl md:w-[45%] lg:w-[35%]"
        >
              ...
              <div>
                ...
                <div className="flex justify-center items-center">
                  <p className="text-4xl">
                    {dataApi.main.temp.toFixed(0)}&deg;
                  </p>
                  <img
                    className="w-36 h-36"
                    src={Iconos(icon)}
                ...
                <p className="text-lg capitalize my-4">
